...
export default props => {
  return (
    <div>
      ...
      <a href={`https://twitter.com/intent/tweet?related=matt_poloni&url=${window.location.href}&hashtags=PicassoPaintedIt`} target="_blank" rel="noopener noreferrer" id='tw-share'>
